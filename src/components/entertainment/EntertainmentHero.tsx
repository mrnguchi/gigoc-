...
const services = [
  { title: 'Artist Management', description: 'Direction and career support', icon: Mic2 },
  { title: 'Talent & Modelling', description: 'Talent and visual campaigns', icon: Camera },
  { title: 'Podcast Production', description: 'Recording and distribution', icon: Radio },
  { title: 'Concert Production', description: 'Planning and live delivery', icon: Ticket },
  { title: 'Brand Campaigns', description: 'Creative brand collaborations', icon: Sparkles },
];
    ...
    const updateCurrentService = () => {
      ...
      frame = window.requestAnimationFrame(() => {
        ...
        slideRefs.current.forEach((slide, index) => {
          if (!slide) return;
          const distance = Math.abs(slide.offsetLeft + slide.clientWidth / 2 - sliderCenter);
    ...
    <section className="relative bg-white">
      <div className="relative min-h-[680px] bg-[#07172b] sm:min-h-[720px] lg:min-h-[760px]">
        <div className="absolute inset-0 overflow-hidden">
          <Image
            src="/music&entertainment_bg.jpg"
            alt="GiGOC Entertainment and Talent production studio"
            fill
            priority
            className="scale-[1.015] object-cover object-center"
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(3,13,27,0.58)_0%,rgba(5,23,45,0.72)_58%,rgba(4,18,35,0.94)_100%)]" />
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(4,17,34,0.48),transparent_48%,rgba(4,17,34,0.28))]" />
        ...
        <div className="relative mx-auto flex min-h-[680px] max-w-7xl items-center justify-center px-5 pb-40 pt-32 text-center sm:min-h-[720px] sm:px-6 sm:pb-44 lg:min-h-[760px] lg:px-10">
          <div className="max-w-4xl">
            ...
            <p className="text-sm font-medium text-white/78">GiGOC Entertainment &amp; Talent</p>
            <h1 className="mx-auto mt-5 max-w-4xl text-4xl font-semibold leading-[1.08] tracking-[-0.035em] text-white sm:text-5xl lg:text-7xl">
              Talent, production and live experiences under one team.
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-white/72 sm:text-lg">
              We work with artists, models and brands across talent development, visual campaigns, media production and live experiences.
            </p>
        ...
        <div className="absolute inset-x-0 bottom-0 z-20 translate-y-1/2 px-4 sm:px-6 lg:px-10">
          <div className="mx-auto flex max-w-7xl items-stretch overflow-hidden border border-slate-200 bg-white shadow-[0_18px_45px_rgba(15,23,42,0.14)]">
            <button
              ...
              aria-label="Show previous entertainment service"
            >
            ...
            <div className="min-w-0 flex-1 overflow-hidden">
              <div
                ...
                aria-label="GiGOC entertainment and talent services"
              >
            ...
            <button
              ...
              aria-label="Show next entertainment service"
            >
